...
$(document).ready(function () {
    ...
    $("iframe").contents().find('body').css('background', 'url("img/citybg1.png") no-repeat center center').css('background-size', 'cover').css('color', '#1C2833').css('font-family', 'Rubik, sans-serif');
    $('iframe').contents().find('body').html('<div class="sign"></div>')
    $('iframe').contents().find('div').css('background', 'url("img/signh1.png") no-repeat center center').css('background-size', 'cover').css('height', '188px').css('width', '280px').css('position', 'absolute').css('top', '40%');
