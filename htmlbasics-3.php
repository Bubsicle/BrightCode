...
margin: 30px;
  ...
  <div class="tab-pane fade" id="cssEditor" role="tabpanel" aria-labelledby="pills-profile-tab">
    ...
    <div class="col-md-12 instruc">
      ...
      <hr>
      <p>Let's say your driving along and you need to get to a city, but their are no signs telling you where a city is. You can put text on the sign!</p>
...
$(document).ready(function () {
    ...
    $("iframe").contents().find('body').css('background', 'url("img/citybg1.svg") no-repeat center center').css('background-size', 'cover').css('color', '#1C2833').css('font-family', 'Rubik, sans-serif');
    $('iframe').contents().find('body').html('<div class="sign"></div>')
    $('iframe').contents().find('div').css('background', 'url("img/signh1.svg") no-repeat center center').css('background-size', 'cover').css('height', '188px').css('width', '280px').css('position', 'absolute').css('top', '40%');
